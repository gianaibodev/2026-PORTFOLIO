        ...
        <div className="max-w-5xl mx-auto space-y-8 sm:space-y-12 md:space-y-16">
          <header className="space-y-6 sm:space-y-8 md:space-y-10">
            <div className="grid gap-4 sm:gap-6 sm:grid-cols-1 md:grid-cols-2">
              <div className="rounded-3xl border border-white/10 backdrop-blur-2xl bg-white/5 dark:bg-white/[0.03] p-4 sm:p-6 space-y-3 sm:space-y-4">
          ...
          <section className="grid gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-3xl border border-white/10 p-4 sm:p-6 backdrop-blur-xl bg-white/5 dark:bg-white/[0.03]">
            ...
            <div className="rounded-3xl border border-white/10 p-4 sm:p-6 backdrop-blur-xl bg-white/5 dark:bg-white/[0.03] sm:col-span-2 lg:col-span-1">
          ...
          {study.sections.map((section) => (
            <section
              key={section.title}
              className="rounded-[24px] sm:rounded-[32px] border border-white/10 backdrop-blur-2xl bg-white/5 dark:bg-white/[0.02] p-4 sm:p-6 md:p-8 space-y-3 sm:space-y-4"
            >
          ...
          {slug === "portfolio-2026-making-of" && (
            <div className="space-y-8 sm:space-y-12">
              <section className="space-y-6">
                ...
                <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
                  {shaderCredits.map((shader) => (
                    <div key={shader.name} className="p-6 rounded-3xl border border-white/20 bg-slate-950/80 dark:bg-black/80 backdrop-blur-3xl space-y-3 shadow-2xl">
              ...
              <section className="space-y-6">
                ...
                <div className="grid gap-3 sm:gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  {libraryCredits.map((lib) => (
                    <div key={lib.name} className="p-5 rounded-2xl border border-white/10 bg-slate-900/60 flex flex-col justify-between gap-3 group hover:border-white/30 transition-all shadow-lg">
                      <div>
              ...
              <section className="p-10 rounded-[40px] bg-gradient-to-br from-slate-900 to-blue-900 border border-white/20 backdrop-blur-3xl text-center shadow-2xl">
          ...
          <section className="rounded-[24px] sm:rounded-[32px] border border-white/10 backdrop-blur-2xl bg-white/5 dark:bg-white/[0.02] p-4 sm:p-6 md:p-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4 sm:gap-6">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 px-4 sm:px-6 py-2 sm:py-3 text-xs sm:text-sm font-semibold text-blue-500 dark:text-blue-300 hover:bg-white/10 transition-colors whitespace-nowrap flex-shrink-0"
            >
