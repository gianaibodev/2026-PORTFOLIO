      ...
      <div className="w-full min-h-screen bg-background">
        ...
        <div className="max-w-3xl mx-auto px-6 py-24 text-center">
          ...
          <div className="mt-8">
            <Link
              href="/projects"
              className="inline-flex items-center justify-center rounded-full border border-black/5 dark:border-white/[0.12] bg-white/40 dark:bg-white/[0.03] px-6 py-3 text-foreground dark:text-white font-bold backdrop-blur-xl shadow-xl transition-all active:scale-95"
            >
              Back to Projects
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 mt-8 sm:mt-12">
          <div className="grid gap-6 sm:gap-8">
            {category.studies.map((study) => (
              <div
                key={study.slug}
                className="rounded-[24px] sm:rounded-[32px] border border-white/10 backdrop-blur-2xl bg-white/5 dark:bg-white/[0.02] p-4 sm:p-6 md:p-8 grid gap-4 sm:gap-6 md:gap-8 md:grid-cols-[2fr,1fr]"
              >
                ...
                <div className="space-y-3 sm:space-y-4 order-1 md:order-2">
                    <ResponsiveImage
                      ...
                      cover={true}
                    />
                  <div className="rounded-xl sm:rounded-2xl border border-white/10 p-3 sm:p-4 text-xs sm:text-sm space-y-2">
