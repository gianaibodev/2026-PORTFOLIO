...
export function PortfolioGallery({
  ...
  return (
    <section
      ...
      id="archives"
    >
      <div className="max-w-7xl mx-auto backdrop-blur-[40px] bg-white/30 dark:bg-black/20 border border-white/20 dark:border-white/10 rounded-[40px] overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)]">
        {/* Header Section */}
        <div className="relative z-10 text-center pt-8 sm:pt-12 md:pt-16 pb-6 sm:pb-8 px-8 shadow-[0_20px_50px_rgba(0,0,0,0.04)] dark:shadow-none">
          ...
          <Link
            ...
            className="inline-flex items-center gap-3 bg-blue-500/10 dark:bg-white/5 border border-blue-500/20 dark:border-white/10 backdrop-blur-2xl text-blue-600 dark:text-white px-10 py-4.5 rounded-full font-bold hover:bg-blue-500/20 dark:hover:bg-white/10 shadow-[0_15px_35px_rgba(59,130,246,0.1)] dark:shadow-none transition-all group mb-24 active:scale-95"
