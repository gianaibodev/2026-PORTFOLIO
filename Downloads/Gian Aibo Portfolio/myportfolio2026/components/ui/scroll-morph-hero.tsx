...
export default function ScrollMorphHero() {
    ...
    const handleSkip = () => {
        ...
        setTimeout(() => {
            const nextSection = document.getElementById("interactive-3d");
            if (nextSection) {
    ...
    useEffect(() => {
        ...
        if (isSkipped) return; // Don't handle scroll if skipped
    ...
    // Update morph and rotate when skipped
    useEffect(() => {
        if (isSkipped) {
            setMorphValue(1);
            setRotateValue(360);
        ...
        <div ref={containerRef} className="relative w-full h-full bg-[#FAFAFA] overflow-hidden">
            ...
            {!isSkipped && (
                ...
                >
                    <Button
                        ...
                        variant="outline"
                        size="sm"
                        className="bg-white/90 backdrop-blur-sm hover:bg-white border-gray-300 shadow-lg"
                    >
            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
                    <motion.p
                        initial={{ opacity: 0 }}
                        animate={introPhase === "circle" && morphValue < 0.5 && !isSkipped ? { opacity: 0.5 - morphValue } : { opacity: 0 }}
                ...
                <motion.div
                    style={{ opacity: isSkipped ? 1 : contentOpacity, y: isSkipped ? 0 : contentY }}
