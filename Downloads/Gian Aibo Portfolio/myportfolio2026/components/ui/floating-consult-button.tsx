      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-32 right-6 z-50 backdrop-blur-3xl bg-white/80 dark:bg-black/60 border border-black/5 dark:border-white/[0.12] rounded-[28px] shadow-2xl p-6 lg:p-8 max-w-[340px] w-[calc(100vw-3rem)]"
          >
            <button
              onClick={() => setIsOpen(false)}
