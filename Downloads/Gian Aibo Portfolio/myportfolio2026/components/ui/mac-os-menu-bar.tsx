...
const MenuDropdown: React.FC<MenuDropdownProps> = ({
  ...
  return (
    <div
      ref={dropdownRef}
      className={`absolute backdrop-blur-3xl z-[100] animate-menuFadeIn bg-white/70 dark:bg-black/40 border border-white/20 dark:border-white/10 shadow-2xl ${isMobile ? "fixed inset-x-4 top-16 mx-auto w-auto" : ""}`}
      style={!isMobile ? {
        left: `${position.x}px`,
        top: `${position.y}px`,
        minWidth: '240px',
...
const MacOSMenuBar: React.FC<MacOSMenuBarProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`backdrop-blur-2xl transition-all duration-300 border shadow-lg ${className} bg-white/40 dark:bg-white/[0.05] border-white/20 dark:border-white/10 saturate-150`}
        style={{
          height: "40px",
          borderRadius: "14px",
        }}
        ...
        <div className="flex justify-between items-center h-full px-3 sm:px-4">
          ...
          <div className="flex items-center space-x-1 sm:space-x-1.5">
            ...
            <div className="hidden md:flex items-center space-x-0.5 mr-1.5" suppressHydrationWarning>
              <Link href="/#home" className="px-2.5 py-1 text-foreground dark:text-white text-[13px] font-medium hover:bg-black/5 dark:hover:bg-white/10 rounded-lg transition-all border border-transparent hover:border-black/5 dark:hover:border-white/10" suppressHydrationWarning>Home</Link>
              <Link href="/projects" className="px-2.5 py-1 text-foreground dark:text-white text-[13px] font-medium hover:bg-black/5 dark:hover:bg-white/10 rounded-lg transition-all border border-transparent hover:border-black/5 dark:hover:border-white/10" suppressHydrationWarning>Projects</Link>
              <Link href="/blog" className="px-2.5 py-1 text-foreground dark:text-white text-[13px] font-medium hover:bg-black/5 dark:hover:bg-white/10 rounded-lg transition-all border border-transparent hover:border-black/5 dark:hover:border-white/10" suppressHydrationWarning>Blog</Link>
              <Link href="/about" className="px-2.5 py-1 text-foreground dark:text-white text-[13px] font-medium hover:bg-black/5 dark:hover:bg-white/10 rounded-lg transition-all border border-transparent hover:border-black/5 dark:hover:border-white/10" suppressHydrationWarning>About</Link>
              <Link href="/#contact" className="px-2.5 py-1 text-foreground dark:text-white text-[13px] font-medium hover:bg-black/5 dark:hover:bg-white/10 rounded-lg transition-all border border-transparent hover:border-black/5 dark:hover:border-white/10" suppressHydrationWarning>Contact</Link>
            </div>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="absolute inset-0 m-3 backdrop-blur-3xl saturate-[180%] bg-white/75 dark:bg-[#1c1c1e]/80 border border-white/20 dark:border-white/10 rounded-[24px] shadow-2xl" />
                ...
                {mobileNavItems.map((item) => {
                  return (
                    <Link
                      ...
                      className="flex flex-col items-center justify-center p-5 rounded-[22px] bg-black/[0.03] dark:bg-white/[0.06] hover:bg-black/[0.05] dark:hover:bg-white/[0.08] transition-all group border border-black/[0.02] dark:border-white/[0.04] active:scale-[0.96] shadow-[0_2px_10px_rgba(0,0,0,0.03)] dark:shadow-none"
                    >
