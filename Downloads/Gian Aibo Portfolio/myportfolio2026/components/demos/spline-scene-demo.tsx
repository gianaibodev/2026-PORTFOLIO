    ...
    <Card className="w-full h-[500px] bg-slate-100 dark:bg-black/[0.96] relative overflow-hidden">
      ...
      <div className="flex h-full flex-col md:flex-row">
        ...
        <div className="flex-1 p-8 relative z-10 flex flex-col justify-center">
          <h1 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-slate-900 to-slate-600 dark:from-neutral-50 dark:to-neutral-400">
            Interactive 3D
          </h1>
        ...
        <div className="flex-1 relative min-h-[300px]">
          <ErrorBoundary
            fallback={
              <div className="w-full h-full flex flex-col items-center justify-center px-6 text-center border-l border-white/10">
