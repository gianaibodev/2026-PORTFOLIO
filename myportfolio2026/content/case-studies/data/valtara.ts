...
export const valtara: CaseStudy = {
    ...
    gallery: [
        "/legacy/assets/demopic/15.jpg",
        "/legacy/assets/demopic/15-a.gif",
        "/legacy/assets/demopic/watch1.gif",
        "/legacy/assets/demopic/billboard.gif",
    ],
    deliverables: [
